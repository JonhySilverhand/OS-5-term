...
#include <cstdlib>
#include "Windows.h"
#define FILE_PATH L"D:/University/5th_term/OS/Lab09/Lab09/OS09_03.txt"
#define DIR_PATH L"D:/University/5th_term/OS/Lab09/Lab09/"
int rowC = 0;
...
BOOL printWatchRowFileTxt(LPWSTR FileName, DWORD mlsec)
{
    ...
    try
    {
        ...
        DWORD dwWaitStatus;
        cout << "\n==================================================\n";
        printf("\tStarted filewatch (timest %d)", t1);
        while (true)
        {
